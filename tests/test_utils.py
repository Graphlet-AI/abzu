...
@pytest.fixture
def state_store(mock_dapr_client: Any) -> DaprStateStore:
    """Create a DaprStateStore instance with mocked client."""
    return DaprStateStore()


@pytest.fixture
def s3_storage(mock_dapr_client: Any) -> DaprS3Storage:
...
class TestDaprStateStore:
    ...
    def test_init(self, mock_dapr_client: Any) -> None:
    ...
    def test_init_custom_store(self, mock_dapr_client: Any) -> None:
    ...
    def test_get_success(self, state_store: DaprStateStore, mock_dapr_client: Any) -> None:
    ...
    def test_get_not_found(self, state_store: DaprStateStore, mock_dapr_client: Any) -> None:
        """Test state retrieval when key doesn't exist."""
        mock_dapr_client.get_state.return_value = None
        result = state_store.get("test-key")
        assert result is None

    def test_get_with_metadata(self, state_store: DaprStateStore, mock_dapr_client: Any) -> None:
    ...
    def test_set_success(self, state_store: DaprStateStore, mock_dapr_client: Any) -> None:
    ...
    def test_set_with_options(self, state_store: DaprStateStore, mock_dapr_client: Any) -> None:
    ...
    def test_delete_success(self, state_store: DaprStateStore, mock_dapr_client: Any) -> None:
    ...
    def test_get_bulk_success(self, state_store: DaprStateStore, mock_dapr_client: Any) -> None:
    ...
    def test_set_bulk_success(self, state_store: DaprStateStore, mock_dapr_client: Any) -> None:
        """Test successful bulk state setting."""
        items = [
            {"key": "key1", "value": "value1", "etag": "etag1"},
            {"key": "key2", "value": "value2", "etag": "etag2"},
        ]
        state_store.set_bulk(items)  # type: ignore[arg-type]
        mock_dapr_client.save_bulk_state.assert_called_once()

    def test_execute_transaction_success(
        self, state_store: DaprStateStore, mock_dapr_client: Any
    ) -> None:
        """Test successful transaction execution."""
        operations = [("upsert", "key1", "value1", None), ("delete", "key2", None, None)]
        state_store.execute_transaction(operations)  # type: ignore[arg-type]
        mock_dapr_client.execute_state_transaction.assert_called_once()

    def test_query_success(self, state_store: DaprStateStore, mock_dapr_client: Any) -> None:
        ...
        result = state_store.query(query)  # type: ignore[arg-type]
    ...
    def test_error_handling(self, state_store: DaprStateStore, mock_dapr_client: Any) -> None:
...
class TestDaprS3Storage:
    ...
    def test_init_custom_binding(self, mock_dapr_client: Any) -> None:
    ...
    def test_upload_success(self, s3_storage: DaprS3Storage, mock_dapr_client: Any) -> None:
        ...
        # Test upload
        result = s3_storage.upload("test.txt", b"test content")  # type: ignore[func-returns-value]
    ...
    def test_download_success(self, s3_storage: DaprS3Storage, mock_dapr_client: Any) -> None:
    ...
    def test_delete_success(self, s3_storage: DaprS3Storage, mock_dapr_client: Any) -> None:
        ...
        # Test delete
        result = s3_storage.delete("test.txt")  # type: ignore[attr-defined]
        assert result is True
    ...
    def test_list_success(self, s3_storage: DaprS3Storage, mock_dapr_client: Any) -> None:
        ...
        # Test list
        result = s3_storage.list("prefix/")  # type: ignore[attr-defined]
    ...
    def test_error_handling(self, s3_storage: DaprS3Storage, mock_dapr_client: Any) -> None:
